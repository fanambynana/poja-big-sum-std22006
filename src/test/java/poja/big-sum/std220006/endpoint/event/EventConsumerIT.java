package poja.big-sum.std220006.endpoint.event;
...
import poja.big-sum.std220006.repository.DummyUuidRepository;
        ...
        List.of(
            new EventConsumer.AcknowledgeableTypedEvent(
                new EventConsumer.TypedEvent(
                    "poja.big-sum.std220006.endpoint.event.gen.UuidCreated", payloadReceived),
                () -> {})));
