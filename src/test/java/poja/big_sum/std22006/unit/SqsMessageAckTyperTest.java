package poja.big_sum.std22006.unit;
...
import poja.big_sum.std22006.endpoint.event.EventConsumer;
  ...
  void to_acknowledgeable_typed_event_ok() throws JsonProcessingException {
    ...
    var typedEvent =
        new EventConsumer.TypedEvent(
            "poja.big-sum.std22006.endpoint.event.gen.UuidCreated", payload);
