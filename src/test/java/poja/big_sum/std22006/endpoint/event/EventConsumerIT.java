package poja.big_sum.std22006.endpoint.event;
...
import poja.big_sum.std22006.endpoint.event.gen.UuidCreated;
import poja.big_sum.std22006.repository.DummyUuidRepository;
        ...
        List.of(
            new EventConsumer.AcknowledgeableTypedEvent(
                new EventConsumer.TypedEvent(
                    "poja.big-sum.std22006.endpoint.event.gen.UuidCreated", payloadReceived),
                () -> {})));
